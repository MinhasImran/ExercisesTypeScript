...
let names = [`Imran`, `Adnan`, `Usman`, `Soban`];
console.log(names[1]);
console.log(names[3]);
console.log(Q1 + 12 + " Use Array and greet friends");
let mes = (`Assalam o Alaikum. You are a lovely person Mr. `);
...
let mes1 = (" Assalam o Alaikum I am happy on your successful completion of business orders and establishing a great business empire. I would like to invite your at dinner on August 23, 2023 at 9:00 PM, at my home. Waiting for your response. Regards Imran");
...
let gcnt = "Allama Iqbal";
console.log(`${gcnt}, can't come to conference.`);
//Step 2 Replace the name of guest 
let newg = "Sir Syed Ahmed";
let indexOfgcnt = glist.indexOf(gcnt);
